...
try:
    ...
    parser.add_argument('-Nl', '--Clustersize', type=int, help='Minimal Clustersize (Min)(default=2)', default=2)    
...
#output.write('Time for the preprocessing: %.2f s\n' %(timepp))
...
output.write('\n')
output.write('Path=. \n')
output.write('Software=%s \n' %Software) # Pfad einfügen (Software)
output.write('Input=${Path} \n') # Pfad einfügen (Arbeitsordner)
